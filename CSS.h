void append_page_header() {
  ...
  webpage += F("<head>");
  webpage += F("<title>Cat Fugatives</title>"); // NOTE: 1em = 16px
  ...
  webpage += F("button{border-radius:0.5em;background:#558ED5;padding:0.3em 0.3em;width:20%;color:black;font-size:130%;}");
  ...
  webpage += F("</style></head><body><h1>Cat Fugatives "); webpage += String(ServerVersion) + "</h1>";
}
//~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
void append_page_footer(){ // Saves repeating many lines of code for HTML page footers
  ...
  webpage += F("<li><a href='/capture'>Capture</a></li>"); 
  webpage += F("</ul>");
